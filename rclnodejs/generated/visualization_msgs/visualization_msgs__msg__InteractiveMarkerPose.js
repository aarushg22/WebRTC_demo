...
const InteractiveMarkerPoseRefStruct = StructType({
  header: HeaderWrapper.refObjectType,
  pose: PoseWrapper.refObjectType,
  name: primitiveTypes.string,
});
const InteractiveMarkerPoseRefArray = ArrayType(InteractiveMarkerPoseRefStruct);
const InteractiveMarkerPoseRefStructArray = StructType({
  data: InteractiveMarkerPoseRefArray,
  size: ref.types.size_t,
  capacity: ref.types.size_t
});
// Define the wrapper class.
class InteractiveMarkerPoseWrapper {
  constructor(other) {
    this._wrapperFields = {};
    if (typeof other === 'object' && other._refObject) {
      this._refObject = new InteractiveMarkerPoseRefStruct(other._refObject.toObject());
  ...
  _initMembers() {
    this._refObject = new InteractiveMarkerPoseRefStruct();
  ...
  static createFromRefObject(refObject) {
    let self = new InteractiveMarkerPoseWrapper();
    self.copyRefObject(refObject);
    return self;
  }
  static createArray() {
    return new InteractiveMarkerPoseArrayWrapper;
  }
  static get ArrayType() {
    return InteractiveMarkerPoseArrayWrapper;
  }
  static get refObjectArrayType() {
    return InteractiveMarkerPoseRefStructArray
  }
  static get refObjectType() {
    return InteractiveMarkerPoseRefStruct;
  }
  toRawROS() {
    this.freeze(true);
  ...
  freeze(own = false, checkConsistency = false) {
    if (checkConsistency) {
      if (!this._nameIntialized) {
        throw new TypeError('Invalid argument: name in InteractiveMarkerPose');
      }
    }
  ...
  static destoryRawROS(msg) {
    InteractiveMarkerPoseWrapper.freeStruct(msg.refObject);
  }
  static type() {
    return {pkgName: 'visualization_msgs', subFolder: 'msg', interfaceName: 'InteractiveMarkerPose'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  copyRefObject(refObject) {
    this._refObject = new InteractiveMarkerPoseRefStruct(refObject.toObject());
...
class InteractiveMarkerPoseArrayWrapper {
  ...
  set size(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to InteractiveMarkerPoseArrayWrapper.size setter');
      return;
    }
  ...
  set capacity(value) {
    if (typeof value != 'number') {
      throw new TypeError('Invalid argument: should provide a number to InteractiveMarkerPoseArrayWrapper.capacity setter');
    }
    return this._resize(value);
  }
  get refObject() {
  ...
  _resize(size) {
    ...
    this._refArray = new InteractiveMarkerPoseRefArray(size);
    this._refObject = new InteractiveMarkerPoseRefStructArray();
    this._refObject.size = size;
    this._refObject.capacity = size;
    this._wrappers = new Array();
    for (let i = 0; i < size; i++) {
      this._wrappers.push(new InteractiveMarkerPoseWrapper());
    }
  }
  ...
  copy(other) {
    if (! (other instanceof InteractiveMarkerPoseArrayWrapper)) {
      throw new TypeError('Invalid argument: should provide "InteractiveMarkerPoseArrayWrapper".');
    }
  ...
  static freeArray(refObject) {
    ...
    for (let index = 0; index < refObject.size; index++) {
      InteractiveMarkerPoseWrapper.freeStruct(refObjectArray[index]);
    }
  }
...
module.exports = InteractiveMarkerPoseWrapper;
/*
