...
const ImuRefStruct = StructType({
  ...
  orientation_covariance: Float64Wrapper.refObjectArrayType,
  angular_velocity: Vector3Wrapper.refObjectType,
  angular_velocity_covariance: Float64Wrapper.refObjectArrayType,
  linear_acceleration: Vector3Wrapper.refObjectType,
  linear_acceleration_covariance: Float64Wrapper.refObjectArrayType,
});
...
class ImuWrapper {
  ...
  freeze(own = false, checkConsistency = false) {
    ...
    this._wrapperFields.orientation_covariance.freeze(own, checkConsistency);
    this._refObject.orientation_covariance = this._wrapperFields.orientation_covariance.refObject;
    ...
    this._wrapperFields.angular_velocity_covariance.freeze(own, checkConsistency);
    this._refObject.angular_velocity_covariance = this._wrapperFields.angular_velocity_covariance.refObject;
    ...
    this._wrapperFields.linear_acceleration_covariance.freeze(own, checkConsistency);
    this._refObject.linear_acceleration_covariance = this._wrapperFields.linear_acceleration_covariance.refObject;
  }
  serialize() {
  ...
  deserialize(refObject) {
    ...
    this._wrapperFields.orientation_covariance.copyRefObject(refObject.orientation_covariance);
    this._wrapperFields.angular_velocity.copyRefObject(refObject.angular_velocity);
    this._wrapperFields.angular_velocity_covariance.copyRefObject(refObject.angular_velocity_covariance);
    this._wrapperFields.linear_acceleration.copyRefObject(refObject.linear_acceleration);
    this._wrapperFields.linear_acceleration_covariance.copyRefObject(refObject.linear_acceleration_covariance);
  }
  toPlainObject() {
  ...
  static freeStruct(refObject) {
    ...
    if (refObject.orientation_covariance.size != 0) {
      Float64Wrapper.ArrayType.freeArray(refObject.orientation_covariance);
      if (Float64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.orientation_covariance, Float64Wrapper.refObjectArrayType, 'data');
      } else {
        deallocator.freeStructMember(refObject.orientation_covariance, Float64Wrapper.refObjectArrayType, 'data');
      }
    }
    Vector3Wrapper.freeStruct(refObject.angular_velocity);
    if (refObject.angular_velocity_covariance.size != 0) {
      Float64Wrapper.ArrayType.freeArray(refObject.angular_velocity_covariance);
      if (Float64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.angular_velocity_covariance, Float64Wrapper.refObjectArrayType, 'data');
      } else {
        deallocator.freeStructMember(refObject.angular_velocity_covariance, Float64Wrapper.refObjectArrayType, 'data');
      }
    }
    Vector3Wrapper.freeStruct(refObject.linear_acceleration);
    if (refObject.linear_acceleration_covariance.size != 0) {
      Float64Wrapper.ArrayType.freeArray(refObject.linear_acceleration_covariance);
      if (Float64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.linear_acceleration_covariance, Float64Wrapper.refObjectArrayType, 'data');
      } else {
        deallocator.freeStructMember(refObject.linear_acceleration_covariance, Float64Wrapper.refObjectArrayType, 'data');
      }
    }
  }
  ...
  copyRefObject(refObject) {
    ...
    this._wrapperFields.orientation_covariance.copyRefObject(this._refObject.orientation_covariance);
    this._wrapperFields.angular_velocity.copyRefObject(this._refObject.angular_velocity);
    this._wrapperFields.angular_velocity_covariance.copyRefObject(this._refObject.angular_velocity_covariance);
    this._wrapperFields.linear_acceleration.copyRefObject(this._refObject.linear_acceleration);
    this._wrapperFields.linear_acceleration_covariance.copyRefObject(this._refObject.linear_acceleration_covariance);
  }
  copy(other) {
    this._refObject = new ImuRefStruct(other._refObject.toObject());
  ...
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"header","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"std_msgs","type":"Header","stringUpperBound":null,"isPrimitiveType":false}},{"name":"orientation","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"geometry_msgs","type":"Quaternion","stringUpperBound":null,"isPrimitiveType":false}},{"name":"orientation_covariance","type":{"isArray":true,"arraySize":9,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":true,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true}},{"name":"angular_velocity","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"geometry_msgs","type":"Vector3","stringUpperBound":null,"isPrimitiveType":false}},{"name":"angular_velocity_covariance","type":{"isArray":true,"arraySize":9,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":true,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true}},{"name":"linear_acceleration","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"geometry_msgs","type":"Vector3","stringUpperBound":null,"isPrimitiveType":false}},{"name":"linear_acceleration_covariance","type":{"isArray":true,"arraySize":9,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":true,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true}}],"baseType":{"pkgName":"sensor_msgs","type":"Imu","stringUpperBound":null,"isPrimitiveType":false},"msgName":"Imu"};
  }
  hasMember(name) {
