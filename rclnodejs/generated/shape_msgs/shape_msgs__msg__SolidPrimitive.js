  ...
  static freeStruct(refObject) {
    if (refObject.dimensions.size != 0) {
      ...
      if (Float64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.dimensions, Float64Wrapper.refObjectArrayType, 'data');
      } else {
