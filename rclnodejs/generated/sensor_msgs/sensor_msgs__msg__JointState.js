...
class JointStateWrapper {
  ...
  static freeStruct(refObject) {
    ...
    if (refObject.name.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.name, StringWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.position.size != 0) {
      ...
      if (Float64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.position, Float64Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.velocity.size != 0) {
      ...
      if (Float64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.velocity, Float64Wrapper.refObjectArrayType, 'data');
      } else {
  ...
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"header","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"std_msgs","type":"Header","stringUpperBound":null,"isPrimitiveType":false}},{"name":"name","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"string","stringUpperBound":null,"isPrimitiveType":true}},{"name":"position","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true}},{"name":"velocity","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true}},{"name":"effort","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true}}],"baseType":{"pkgName":"sensor_msgs","type":"JointState","stringUpperBound":null,"isPrimitiveType":false},"msgName":"JointState"};
  }
  hasMember(name) {
