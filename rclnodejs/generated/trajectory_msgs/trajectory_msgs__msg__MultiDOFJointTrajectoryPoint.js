...
class MultiDOFJointTrajectoryPointWrapper {
  ...
  static freeStruct(refObject) {
    ...
    if (refObject.velocities.size != 0) {
      ...
      if (TwistWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.velocities, TwistWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.accelerations.size != 0) {
      ...
      if (TwistWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.accelerations, TwistWrapper.refObjectArrayType, 'data');
      } else {
  ...
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"transforms","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":"geometry_msgs","type":"Transform","stringUpperBound":null,"isPrimitiveType":false}},{"name":"velocities","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":"geometry_msgs","type":"Twist","stringUpperBound":null,"isPrimitiveType":false}},{"name":"accelerations","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":"geometry_msgs","type":"Twist","stringUpperBound":null,"isPrimitiveType":false}},{"name":"time_from_start","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"builtin_interfaces","type":"Duration","stringUpperBound":null,"isPrimitiveType":false}}],"baseType":{"pkgName":"trajectory_msgs","type":"MultiDOFJointTrajectoryPoint","stringUpperBound":null,"isPrimitiveType":false},"msgName":"MultiDOFJointTrajectoryPoint"};
  }
  hasMember(name) {
