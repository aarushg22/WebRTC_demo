...
const SaveMap_RequestRefStruct = StructType({
  filename: StringWrapper.refObjectType,
});
...
class SaveMap_RequestWrapper {
  ...
  freeze(own = false, checkConsistency = false) {
    ...
    this._wrapperFields.filename.freeze(own, checkConsistency);
  ...
  deserialize(refObject) {
    this._wrapperFields.filename.copyRefObject(refObject.filename);
  }
  toPlainObject() {
  ...
  static type() {
    return {pkgName: 'map_msgs', subFolder: 'srv', interfaceName: 'SaveMap_Request'};
  }
  static isPrimitive() {
    return false;
  }
  ...
  get filename() {
    return this._wrapperFields.filename;
  }
  set filename(value) {
    this._wrapperFields.filename.copy(value);
  }
  ...
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"filename","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":"std_msgs","type":"String","stringUpperBound":null,"isPrimitiveType":false}}],"baseType":{"pkgName":"map_msgs","type":"SaveMap_Request","stringUpperBound":null,"isPrimitiveType":false},"msgName":"SaveMap_Request"};
  }
  hasMember(name) {
