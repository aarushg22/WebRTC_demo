...
class ParameterValueWrapper {
  ...
  static freeStruct(refObject) {
    ...
    if (refObject.byte_array_value.size != 0) {
      ...
      if (ByteWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.byte_array_value, ByteWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.bool_array_value.size != 0) {
      ...
      if (BoolWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.bool_array_value, BoolWrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.integer_array_value.size != 0) {
      ...
      if (Int64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.integer_array_value, Int64Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.double_array_value.size != 0) {
      ...
      if (Float64Wrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.double_array_value, Float64Wrapper.refObjectArrayType, 'data');
      } else {
    ...
    if (refObject.string_array_value.size != 0) {
      ...
      if (StringWrapper.ArrayType.useTypedArray) {
        deallocator.delayFreeStructMember(refObject.string_array_value, StringWrapper.refObjectArrayType, 'data');
      } else {
  ...
  static get ROSMessageDef() {
    return {"constants":[],"fields":[{"name":"type","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":null,"type":"uint8","stringUpperBound":null,"isPrimitiveType":true}},{"name":"bool_value","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":null,"type":"bool","stringUpperBound":null,"isPrimitiveType":true}},{"name":"integer_value","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":null,"type":"int64","stringUpperBound":null,"isPrimitiveType":true}},{"name":"double_value","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true}},{"name":"string_value","type":{"isArray":false,"arraySize":null,"isUpperBound":false,"isDynamicArray":false,"isFixedSizeArray":false,"pkgName":null,"type":"string","stringUpperBound":null,"isPrimitiveType":true}},{"name":"byte_array_value","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"byte","stringUpperBound":null,"isPrimitiveType":true}},{"name":"bool_array_value","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"bool","stringUpperBound":null,"isPrimitiveType":true}},{"name":"integer_array_value","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"int64","stringUpperBound":null,"isPrimitiveType":true}},{"name":"double_array_value","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"float64","stringUpperBound":null,"isPrimitiveType":true}},{"name":"string_array_value","type":{"isArray":true,"arraySize":null,"isUpperBound":false,"isDynamicArray":true,"isFixedSizeArray":null,"pkgName":null,"type":"string","stringUpperBound":null,"isPrimitiveType":true}}],"baseType":{"pkgName":"rcl_interfaces","type":"ParameterValue","stringUpperBound":null,"isPrimitiveType":false},"msgName":"ParameterValue"};
  }
  hasMember(name) {
